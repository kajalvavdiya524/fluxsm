...
<head>
  <title>New Work Order | Flux Shop Manager</title>
  ...
  <div class="content-wrapper">
  	...
  	<div class="d-print-block">
  		<div class="row no-gutters">
			  ...
			  <img class="mr-3" src="MLT-Logo.jpg" style="max-height:50px">
    ...
    <div class="container-fluid">
      ...
      <div class="row d-print-none">
			  ...
			  <div class="card-body">
				...
				<p></p>
		   		<div class="row">
			    	...
			    	<div class="col-lg-6">
   						<a href="#" id="customerAddBtn" class="btn btn-secondary form-control form-control-lg">Add New</a>
			  		</div>
		  		</div>
			    <p></p>
        ...
        <div class="col-lg-6">
			<div class="card mb-3" id="vehicleCard">
			  ...
			  <div class="card-body">
			    <h4 class="card-title">Search for Vehicle</h4>
				<div class="row">
					<div class="col-lg-12">
   						<div class="input-group">
			      			<input type="text" id="searchLicensePlate" class="form-control form-control-lg" placeholder="License Plate">
			    		</div>
		    		</div>
		  		</div>
   				<p></p>
		   		<div class="row">
					<div class="col-lg-6">
   						<a href="#" id="vehicleSearchBtn" class="btn btn-primary form-control form-control-lg">Search</a>
		    		</div>
			    	<div class="col-lg-6">
   						<a href="#" data-toggle="modal" data-target="#addVehicleModal" id="vehicleAddBtn" class="btn btn-secondary form-control form-control-lg disabled">Add New</a>
			  		</div>
		  		</div>
			  	<p></p>
			    <div id="vehicleList">
        ...
        <div class="col">
			<div class="card" id="totalsCard">
			  ...
			  <div class="card-body">
			    ...
			    <a href="#" id="workOrderSaveBtn" class="btn btn-primary d-print-none">Save</a> <a href="#" id="saveAndPrintBtn" class="btn btn-primary d-print-none">Save & Print</a>
      ...
      <div class="row printFooter d-print-block">
		...
		<div class="modal fade" id="addCustomerModal" tabindex="-1"
			role="dialog" aria-labelledby="addCustomerModalLabel"
			aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="addCustomerModal">Add New Customer</h5>
					...
					<div class="modal-body">
						...
						<form id="customerInfoForm">
							...
							<div class="form-group">
								...
								<input type="email" class="form-control contactSerialize" name="email" id="customerInfoEmail" placeholder="Email">
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
							...
							<div class="collapse" id="collapseAddress">
								<div class="form-group">
									...
									<input type="text" class="form-control customerSerialize workOrderRequired" name="addressline1" id="customerInfoAddressLine1" placeholder="1234 Main St">
								</div>
								<div class="form-group">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control customerSerialize workOrderRequired" name="city" id="customerInfoCity">
									</div>
									...
									<div class="form-group col-md-2">
										...
										<input type="text" class="form-control customerSerialize workOrderRequired" id="customerInfoZip" name="zip">
									</div>
								</div>
							</div>
						...
						<form id="vehicleAddForm">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-4">
									...
									<input type="hidden" class="vehicleSerialize" name="customer_id" value="" id="vehicleAddCustomerId">
								</div>
							</div>
						</form>
					</div>
